...
-- Tab definitions
local TAB_CONFIGS = {
    { key = "Basics",     label = "基础",   icon = "B", screens = safeRequire("examples.kitchen_sink.BasicsScreens") },
    { key = "Forms",      label = "表单",   icon = "F", screens = safeRequire("examples.kitchen_sink.FormsScreens") },
    { key = "Lists",      label = "列表",   icon = "L", screens = safeRequire("examples.kitchen_sink.ListsScreens") },
    { key = "Nav",        label = "导航",   icon = "N", screens = safeRequire("examples.kitchen_sink.NavigationScreens") },
    { key = "Animation",  label = "动画",   icon = "A", screens = safeRequire("examples.kitchen_sink.AnimationScreens") },
    { key = "Interop",    label = "互操",   icon = "I", screens = safeRequire("examples.kitchen_sink.InteropScreens") },
}
